<template>
  <div class="tongyi-wanxiang-video-generation">
    <div class="page-content">
      <aside class="sidebar">
        <div class="control-section">
          <h3 class="section-title">参数配置</h3>
          <TongyiWanxiangParameterForm
...
<script setup>
import { ref } from 'vue'
import TongyiWanxiangParameterForm from '../components/TongyiWanxiangParameterForm.vue'
...
import {
  ...
  getErrorMessage,
  WANXIANG_MODEL
} from '../services/tongyiWanxiangApi.js'
...
const modelInfo = ref(WANXIANG_MODEL)
